package ianic.simpleweatherforecast.models.HttpResponses.Weather;
...
/**
 * Created by Ivan Anić on 20.10.2016..
 */
...
public class WeatherData {
     ...
     * @param main
     */
    public WeatherData(Coord coord, Sys sys, List<Weather> weather, String base, Main main, Wind wind, Clouds clouds, Integer dt, Integer id, String name, Integer cod) {
        this.coord = coord;
        this.sys = sys;
